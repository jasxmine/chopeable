    ...
    <div id="app" class="justify-content-center">
        <b-row>
            ...
            <b-col cols="2">
                <br />
                <b-row>
                    <b-button class="btn1" size="lg" @click="increaseCounter(50)">Increase</b-button>
                </b-row>
                <b-row>
                    <b-button class="btn2" size="lg" @click="decreaseCounter(0)">Decrease</b-button>
                </b-row>
                <b-row>
                    <b-button class="btn3" size="lg" @click="resetCounter">Reset</b-button>
                </b-row>
            </b-col>
        </b-row>
