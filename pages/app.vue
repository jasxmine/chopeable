<template>
  <div style="margin-top: 0px" @click="emptyFocusOut" @mouseover="canScroll">
    <div class="header" style="text-align: middle">
      <br /><br /><br /><br />
      <h3 class="white_text" style="font-size: 50px">Don't know what to eat?</h3>
    ...
    <br />
    <div id="carousel" class="carousel slide" data-ride="true" data-interval="false">
    ...
    <br />
    <div id="carousel2" class="carousel slide" data-ride="true" data-interval="false">
      <div class="carousel-inner">
        <div class="carousel-item active">
